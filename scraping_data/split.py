...
# Room layouts
# input_folder = 'dataset/room_layouts/combine'
# output_folder = 'dataset/room_layouts'
        
# Furnishing
input_folder = 'dataset/furnishing/combine'
output_folder = 'dataset/furnishing'

# Spit (default: Train: 70%, Validation: 15%, Test: 15%)
